#' A function to create unique color, line type, and point type  for up to two groups to be plotted
#'
...
ch.getPlotLegendVals.old <- function (df.grpIndex, maxIntensityChanges = 8, maxHueChanges = 10) {
