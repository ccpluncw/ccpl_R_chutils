...
ch.stripPlotByGrp <- function (data, xCol, xSortColBy, grpCols, grpLgndNames = NULL, filename = NULL, lgndPlacement = "topright", cex1 = 1,cexLegend = 0.75, ylim=c(-1,1), yLab = NA, pch=1, las=2, parOp = NULL, ...) {
